                                ...
                                <FormItem>
                                  ...
                                  <FormControl>
                                    <div className="flex items-center w-full border border-gray-200 rounded-md overflow-hidden">
                                      <label className="flex-shrink-0 px-4 py-2 select-none cursor-pointer text-sm font-medium" aria-hidden={false}>
                                        <input type="file" className="sr-only" onChange={(e) => { const file = e.target.files?.[0] ?? null; field.onChange(file); }} />
