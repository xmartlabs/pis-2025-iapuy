...
export interface Props{
    statusType:"Pendiente de asignación"|"Cupo completo"|"Realizada"|"Finalizada"|"Suspendida";
}
...
export default function InterventionBadge({statusType}:Props) {
    ...
    return (
        <Badge 
        className={`${className} !font-sans !font-semibold !text-xs !leading-4 !text-[#1B2F13]`}        
        >
            {statusType}
        </Badge>
    )
