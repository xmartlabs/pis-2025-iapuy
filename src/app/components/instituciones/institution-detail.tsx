...
const ReferentCard = ({ Contact }: ReferentCardProps) => (
  <div
    className="max-w-[351px] max-h-[88px] gap-10 
      ...
      <DropdownMenuContent className="w-[320px] p-4" align="end" side="bottom">
        <div className="flex flex-row gap-4">
          <div className="flex flex-col flex-1">
            ...
            <Select
              value={selectedMes}
              onValueChange={(nuevoMes) => {
                handleChange(nuevoMes, selectedAnio);
              }}
            >
          ...
          <div className="flex flex-col flex-1">
            ...
            <Select
              value={selectedAnio}
              onValueChange={(nuevoAnio) => {
                handleChange(selectedMes, nuevoAnio);
              }}
            >
              <SelectTrigger className="w-full">
...
const InterventionGrid = ({ id }: { id: string }) => {
  ...
  // confirmation dialog state for deleting interventions
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        const result =
          (await response.json()) as PaginationResultDto<APIInstitutionIntervention>;
        setData(result.data ?? []);
  ...
  return (
    <div className="flex flex-col gap-[20px]">
      ...
      {/* Confirmation dialog for deleting an intervention */}
      <Dialog open={confirmOpen} onOpenChange={setConfirmOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Confirmar eliminación</DialogTitle>
            <DialogDescription>
              ¿Estás seguro que deseas eliminar esta intervención? Esta acción
